...
const Privacy = () => { 
  return (
    <div className="text-content pb-5 mb-5">
        ...
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Monad Domains.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to Monad Domains, accessible from <a href="https://monadns.com" rel="external nofollow noopener" target="_blank"> https://monadns.com</a></p>
        </li>
        <li>
